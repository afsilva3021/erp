     ...
     <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item dropdown no-arrow">
             ...
             <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                 ...
                 <a class='dropdown-item' data-toggle='modal' data-target='#logoutModal'><i class='fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400'></i>Sair</a>
             </div>
         </li>
                     ...
                     <div class="col">
                         ...
                         <form class="row g-3">
                             <div class="col-md-6">
                               ...
                               <?php  echo" <input type='email' class='form-control' id='inputNome' value='".$_SESSION['USR_NOME']."' disabled>"; ?>
                             </div>
                             <div class="col-md-6">
                                 <label for="inputPassword4" class="form-label">Departamento</label>
                                <?php echo" <input type='text' class='form-control' id='inputDepartamento' value='".$_SESSION["USR_DEPART"]."' disabled>"; ?>
                             </div>
                             <div class="col-12">
                                 <label for="inputAddress" class="form-label">Cargo</label>
                                <?php echo" <input type='text' class='form-control' id='inputCargo' value='".$_SESSION["USR_CARGO"]."' disabled>"; ?>
                             </div>
                             <div class="col-12">
                                 <label for="inputAddress2" class="form-label">Email</label>
                                <?php echo"  <input type='Email' class='form-control' id='inputEmail' value='".$_SESSION["email"]."' disabled>"; ?>
                             </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Tem certeza que deseja sair do ERP ?.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="../Models/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>